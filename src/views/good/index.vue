...
goodstore.getCates(cate_id.value);

const good_list = computed(() => {
  return goodstore.good_list;
});

const nav_list = computed(() => {
  return goodstore.nav_list;
});
  ...
  <div class="container bg-white">
    <div class="row">
      ...
      <div class="col-md-12">
        <ol class="breadcrumb">
          ...
          <li class="" v-for="(v, i) in nav_list[cate_id]" :key="v.cate_id">
            <i> /</i>
            ...
            <template v-else>
              <router-link
                :to="nav_list[cate_id][0].slug + '?cate_id=' + v.cate_id"
                >{{ v.name }}
              </router-link>
            </template>
          </li>
    ...
    <div class="row">
      ...
      <div
        ...
        v-for="(v, i) in good_list[cate_id]"
        :key="v.good_id"
      >
