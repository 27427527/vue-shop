...
<div class="container">
      <div class="auth-card">
        ...
        <div class="tabs">
          ...
          <!-- 登录表单 -->
          <form class="form" :class="{ hidden: activeTab !== 'login' }" @submit.prevent="handleLogin">
          ...
          <!-- 注册表单 -->
          <form class="form" :class="{ hidden: activeTab !== 'register' }" @submit.prevent="handleRegister">
            <div class="input-group">
            ...
            <div class="input-group">
              ...
              <input 
                ...
                required
              >
              <span class="error" v-if="registerErrors.password_confirmation">{{ registerErrors.password_confirmation }}</span>
            </div>
